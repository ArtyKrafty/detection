...
Рекомендуется устанавливать в `virtuenv`. Не устанавливать в `conda` если у вас M1 процессор -  будет возникать 
ошибка при попытке запуска detectron2  - `zsh: illegal hardware instruction  python`.
