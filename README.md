...
Реализовно дополнительно web-приложение с ограниченной функциональностью - Находится по адресу: https://detartyseg.herokuapp.com/. К сожалению - пришлось обрезать функционал, из-за ограничений размера на приложение. Локально вы сможете работать и с видео. Также, воможен запуск через [Docker](https://www.docker.com/) - инструкция в соответствующей части файла [Readme.md](#link)
